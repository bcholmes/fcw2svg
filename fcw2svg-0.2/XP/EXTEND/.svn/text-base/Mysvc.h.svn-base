...
DevU * XPCALL DevUseRepaint(HDC hDC, HWND hWnd);
void XPCALL DevUseColor(int Color);
void XPCALL DevUseColorE(int Color);
...
//
/// Fix to always call the straight DLScan and not Mikes new function
//

#define DLScan DLScan1
