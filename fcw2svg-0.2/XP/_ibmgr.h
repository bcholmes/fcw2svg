...
#define RegIBlk _RegIBlk
char _stdcall RegIBlk(int IBlk, void *Adr);
#define GetIBlk _GetIBlk
void * _stdcall GetIBlk(int IBlk);
#define SizeIBlk _SizeIBlk
char _stdcall SizeIBlk(int IBlk, int NewSize);
#define DelIBlk _DelIBlk
char _stdcall DelIBlk(int IBlk);
#define ReadIBlk _ReadIBlk
char _stdcall ReadIBlk(char *Address);
#define RestoreIBlk _RestoreIBlk
char _stdcall RestoreIBlk(char *Address);

#define GetHeaderAdr _GetHeaderAdr
HDR * _stdcall GetHeaderAdr(void);
